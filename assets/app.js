  ...
  <footer class="footer">
    <div class="container">
      ...
      <div class="footer-bottom">
        <div>© ${new Date().getFullYear()} Karostartup. All rights reserved. <span class="footer-credit">Built and maintained by <a href="#" rel="noopener">Hebrew Technologies</a>.</span></div>
        <div class="socials">
